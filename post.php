...
$posts = [
    [
        'id' => 1,
        'title' => "The Road Ahead ({$postId})",
        'subtitle' => 'The road ahead might be paved - it might not be.',
        'image_post' => 'http://localhost/images/northern-lights.png',
        'article' => 'Dark spruce forest frowned on either side the frozen waterway. The trees had been stripped by a recent
...
<body>
    ...
    <main class="container">
        <<div class="intro">
            ...
            <div class="images">
                <img src="<?= $posts[0]['image_post'] ?>" alt="A picture of the northern lights">
            </div>
            <div class="info">
                <p>
                    <?= $posts[0]['article'] ?>
